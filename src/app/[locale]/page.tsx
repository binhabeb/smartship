      ...
      <FadeInView>
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="https://wa.me/8619383079080" className="btn-whatsapp" style={{ padding: '14px 36px', fontSize: 16, textDecoration: 'none' }}>💬 {t.hero.ctaExpert}</a>
          </div>
        </div>
      </FadeInView>
    </section>
...
function WhatsAppFAB() {
  return (
    <a href="https://wa.me/8619383079080?text=أهلاً شركة بن حبيب، لدي استفسار بخصوص استيراد شحنة من الصين..." className="whatsapp-fab" target="_blank" rel="noopener noreferrer">
